const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-B1d1xoEQ.js","assets/index-zIHjjq_n.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-zIHjjq_n.js";
import { C as Card } from "./Card-DYi9kzJe.js";
import { B as Button } from "./Button-BJKNpgCe.js";
import { A as AnimatePresence, m as motion } from "./proxy-Dbv4fB6n.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-B1d1xoEQ.js");
