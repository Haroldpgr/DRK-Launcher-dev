const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-CoLqA7g-.js","assets/index-BYFB9r8B.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-BYFB9r8B.js";
import { C as Card } from "./Card-BX37w_2y.js";
import { B as Button } from "./Button-qsB_nj7Q.js";
import { A as AnimatePresence, m as motion } from "./proxy-2PT02H-E.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-CoLqA7g-.js");
