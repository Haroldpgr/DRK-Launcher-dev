const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B_KZpQPc.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { r as reactExports, j as jsxDevRuntimeExports, _ as __vitePreload } from "./index-B_KZpQPc.js";
import { B as Button } from "./Button-B-Ssyaja.js";
import { s as showModernAlert } from "./uiUtils-HKGKR7Mf.js";
            ...
            onClick: async () => {
              ...
              try {
                ...
                const handleAuthSuccess = async (authData) => {
                  ...
                  try {
                    const profileService = await __vitePreload(() => import("./index-B_KZpQPc.js").then((n) => n.d), true ? __vite__mapDeps([0,1]) : void 0);
                  ...
                  if (authWindow.closed) {
                    ...
                    try {
                      const { profileService } = await __vitePreload(async () => {
                        const { profileService: profileService2 } = await import("./index-B_KZpQPc.js").then((n) => n.d);
