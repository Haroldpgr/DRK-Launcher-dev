const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-BVdv0G4y.js","assets/index-mXJx6f9U.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-mXJx6f9U.js";
import { C as Card } from "./Card-C8IZtjIl.js";
import { B as Button } from "./Button-CETxPEPH.js";
import { A as AnimatePresence, m as motion } from "./proxy-D_kBBIIS.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-BVdv0G4y.js");
