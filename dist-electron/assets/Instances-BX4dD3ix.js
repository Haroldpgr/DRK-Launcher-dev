const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-DVj0XA6s.js","assets/downloadService-CJ6fxaaw.js","assets/index-Doo-7BUy.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-Doo-7BUy.js";
import { instanceProfileService } from "./instanceProfileService-DX9IWZVA.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-BUXrskIF.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-DVj0XA6s.js");
