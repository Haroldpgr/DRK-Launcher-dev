const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-DdPsqObn.js","assets/index-U_2yIX1v.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-U_2yIX1v.js";
import { C as Card } from "./Card-Di7auPWx.js";
import { B as Button } from "./Button-Dbl6zu16.js";
import { A as AnimatePresence, m as motion } from "./proxy-B6UcYJfD.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-DdPsqObn.js");
