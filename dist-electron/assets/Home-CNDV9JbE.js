const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-Bpw8ETEb.js","assets/index-kMUzvZgn.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-kMUzvZgn.js";
import { C as Card } from "./Card-BoJFjKM9.js";
import { B as Button } from "./Button-B6kGY0Nq.js";
import { A as AnimatePresence, m as motion } from "./proxy-raSZFoLO.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-Bpw8ETEb.js");
