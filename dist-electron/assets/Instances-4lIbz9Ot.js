const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-QT7V3PC2.js","assets/downloadService-D7E2ySOh.js","assets/index-o4fEJNsq.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-o4fEJNsq.js";
import { instanceProfileService } from "./instanceProfileService-RZ6YcKd-.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-Bo9YPS5P.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-QT7V3PC2.js");
