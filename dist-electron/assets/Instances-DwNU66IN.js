const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-P7p9ni5b.js","assets/downloadService-BXM1MQYw.js","assets/index-B_KZpQPc.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-B_KZpQPc.js";
import { instanceProfileService } from "./instanceProfileService-CfIFka5i.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-BZXubxBd.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-P7p9ni5b.js");
