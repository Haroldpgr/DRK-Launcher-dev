const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-BJivwuJ2.js","assets/index-BFQ98g3l.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-BFQ98g3l.js";
import { C as Card } from "./Card-DeQbEGYi.js";
import { B as Button } from "./Button-raVyP4Lf.js";
import { A as AnimatePresence, m as motion } from "./proxy-BvGRotGn.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-BJivwuJ2.js");
