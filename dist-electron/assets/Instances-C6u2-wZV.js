const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-DFLBE_08.js","assets/downloadService-CxI4DU3A.js","assets/index-zIHjjq_n.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-zIHjjq_n.js";
import { instanceProfileService } from "./instanceProfileService-B1d1xoEQ.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-C4kfgdL9.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-DFLBE_08.js");
