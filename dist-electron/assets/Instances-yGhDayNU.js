const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-CorsG-wq.js","assets/downloadService-B5P5EM3u.js","assets/index-DD-fmMB8.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-DD-fmMB8.js";
import { instanceProfileService } from "./instanceProfileService-Czy_YEln.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CD-eeXnq.js";
import { A as AnimatePresence, m as motion } from "./proxy-DDx4b4qf.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-CorsG-wq.js");
