const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-DzTJnV8X.js","assets/downloadService-Cd0SdIep.js","assets/index-B1Up_viy.js","assets/index-D2wnz6PA.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-B1Up_viy.js";
import { instanceProfileService } from "./instanceProfileService-CtF2E6yU.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CuVctk2b.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-DzTJnV8X.js");
