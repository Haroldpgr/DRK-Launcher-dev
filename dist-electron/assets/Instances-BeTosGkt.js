const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-BHvmJmma.js","assets/downloadService-ySJiXq49.js","assets/index-3S8JWReM.js","assets/index-B4L-bEA7.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-3S8JWReM.js";
import { instanceProfileService } from "./instanceProfileService-DIkxjIWD.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-DNRHVgHp.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-BHvmJmma.js");
