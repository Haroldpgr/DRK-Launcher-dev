const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-D8NEqVj8.js","assets/index-DKu6ENU1.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-DKu6ENU1.js";
import { C as Card } from "./Card-QSO0aNol.js";
import { B as Button } from "./Button-CI0OpZ40.js";
import { A as AnimatePresence, m as motion } from "./proxy-BhNk_Hym.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-D8NEqVj8.js");
