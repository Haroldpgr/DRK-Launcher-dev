const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-B0K4u2Qc.js","assets/downloadService-BcaPNHp8.js","assets/index-BYFB9r8B.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-BYFB9r8B.js";
import { instanceProfileService } from "./instanceProfileService-CoLqA7g-.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-BBkfIKDL.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-B0K4u2Qc.js");
