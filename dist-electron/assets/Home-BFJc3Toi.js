const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-RZ6YcKd-.js","assets/index-o4fEJNsq.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-o4fEJNsq.js";
import { C as Card } from "./Card-CLqNSFaq.js";
import { B as Button } from "./Button-lMwG_enL.js";
import { A as AnimatePresence, m as motion } from "./proxy-cXK-i4Y5.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-RZ6YcKd-.js");
