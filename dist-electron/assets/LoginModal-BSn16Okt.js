const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-UwK6D_SP.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { r as reactExports, j as jsxDevRuntimeExports, _ as __vitePreload } from "./index-UwK6D_SP.js";
import { B as Button } from "./Button-CRmWtuOe.js";
import { s as showModernAlert } from "./uiUtils-DkErVUAD.js";
            ...
            onClick: async () => {
              ...
              try {
                ...
                const handleAuthSuccess = async (authData) => {
                  ...
                  try {
                    const profileService = await __vitePreload(() => import("./index-UwK6D_SP.js").then((n) => n.d), true ? __vite__mapDeps([0,1]) : void 0);
                  ...
                  if (authWindow.closed) {
                    ...
                    try {
                      const { profileService } = await __vitePreload(async () => {
                        const { profileService: profileService2 } = await import("./index-UwK6D_SP.js").then((n) => n.d);
