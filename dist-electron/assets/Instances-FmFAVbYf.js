const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-C45lgP2z.js","assets/downloadService-DgE80Nak.js","assets/index-CBCIeQaY.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-CBCIeQaY.js";
import { instanceProfileService } from "./instanceProfileService-Dmgqw-qH.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal--GNW5CEb.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-C45lgP2z.js");
