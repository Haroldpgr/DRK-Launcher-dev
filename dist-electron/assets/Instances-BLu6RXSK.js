const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-BQnyMR_b.js","assets/downloadService-CijoSkgR.js","assets/index-DsCTj-1P.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-DsCTj-1P.js";
import { instanceProfileService } from "./instanceProfileService-CmnJEgic.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-DhlU-g4u.js";
import { A as AnimatePresence, m as motion } from "./proxy-BMv6ORD_.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-BQnyMR_b.js");
