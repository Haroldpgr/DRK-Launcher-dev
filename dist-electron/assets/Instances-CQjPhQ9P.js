const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-DppNJH1n.js","assets/downloadService-BKbuPgGP.js","assets/index-kMUzvZgn.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-kMUzvZgn.js";
import { instanceProfileService } from "./instanceProfileService-Bpw8ETEb.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-Q3yJATCI.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-DppNJH1n.js");
