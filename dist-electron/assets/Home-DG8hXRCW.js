const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-6Y9BVYGn.js","assets/index-C3fgt0AJ.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-C3fgt0AJ.js";
import { C as Card } from "./Card-D0OPDPfl.js";
import { B as Button } from "./Button-DmqqFjtM.js";
import { A as AnimatePresence, m as motion } from "./proxy-DyHq3sMb.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-6Y9BVYGn.js");
