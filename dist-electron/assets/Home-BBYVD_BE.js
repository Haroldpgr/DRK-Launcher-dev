const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-BsKkA16D.js","assets/index-CjRbyD_F.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-CjRbyD_F.js";
import { C as Card } from "./Card-BpK-qJJi.js";
import { B as Button } from "./Button-Z2haNW2y.js";
import { A as AnimatePresence, m as motion } from "./proxy-C_YEp7-B.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-BsKkA16D.js");
