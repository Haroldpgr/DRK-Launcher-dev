const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-C7fGdzSV.js","assets/downloadService-R5a5nPT6.js","assets/index-DDW-oKQM.js","assets/index-B4L-bEA7.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-DDW-oKQM.js";
import { instanceProfileService } from "./instanceProfileService-Bek_ATjS.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CpP63ppv.js";
import { A as AnimatePresence, m as motion } from "./proxy-BpHY9lr8.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-C7fGdzSV.js");
