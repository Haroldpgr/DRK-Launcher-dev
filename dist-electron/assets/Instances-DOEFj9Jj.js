const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-3BJhk8N3.js","assets/downloadService-C9jS-uir.js","assets/index-CWWzT4r9.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-CWWzT4r9.js";
import { instanceProfileService } from "./instanceProfileService-BLvMR6lZ.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-BP4fYCeF.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-3BJhk8N3.js");
