const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-dnEJpkIE.js","assets/index-BmOgVBUa.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-BmOgVBUa.js";
import { C as Card } from "./Card-BPtHsKUi.js";
import { B as Button } from "./Button-CEXyd6C2.js";
import { A as AnimatePresence, m as motion } from "./proxy-C-Fo7Qpv.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-dnEJpkIE.js");
