const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-DIkxjIWD.js","assets/index-3S8JWReM.js","assets/index-B4L-bEA7.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-3S8JWReM.js";
import { C as Card } from "./Card-B-TpWxHK.js";
import { B as Button } from "./Button-DM4Mq0dW.js";
import { A as AnimatePresence, m as motion } from "./proxy-8EFuVWV0.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-DIkxjIWD.js");
