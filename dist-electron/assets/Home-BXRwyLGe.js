const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-DPJJ8lb-.js","assets/index-CI5nMIBs.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-CI5nMIBs.js";
import { C as Card } from "./Card-BSjCSXrp.js";
import { B as Button } from "./Button-CS39fwOR.js";
import { A as AnimatePresence, m as motion } from "./proxy-D8yY7m6b.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-DPJJ8lb-.js");
