const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-Ck-UZFXr.js","assets/downloadService-0pcY3zBE.js","assets/index-CL9LFajx.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-CL9LFajx.js";
import { instanceProfileService } from "./instanceProfileService-CfbJIieZ.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-g_14mNZm.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-Ck-UZFXr.js");
