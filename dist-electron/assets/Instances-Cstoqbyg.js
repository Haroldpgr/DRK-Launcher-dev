const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-CQg_II9F.js","assets/downloadService-DIr8HPjU.js","assets/index-DP_CT07l.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-DP_CT07l.js";
import { instanceProfileService } from "./instanceProfileService-CQDaISAQ.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CzcFR5gG.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-CQg_II9F.js");
