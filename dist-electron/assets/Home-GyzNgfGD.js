const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-DyJJNqj_.js","assets/index-BORWVLYp.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-BORWVLYp.js";
import { C as Card } from "./Card-zbe2w0ug.js";
import { B as Button } from "./Button-CU28BxcD.js";
import { A as AnimatePresence, m as motion } from "./proxy-CeG07ayF.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-DyJJNqj_.js");
