import { r as reactExports, j as jsxDevRuntimeExports, p as profileService } from "./index-CCsQX1om.js";
...
class JavaConfigService {
  ...
  static getStandardJvmArgs(loader, ramMb) {
    ...
    const baseArgs = [
      ...
      // Optimizaciones JIT para mejor rendimiento
      "-XX:+UseStringDeduplication",
      "-XX:+OptimizeStringConcat",
      "-XX:+UseCompressedOops",
      "-XX:+UseCompressedClassPointers",
      // Optimizaciones de red y I/O (mejora generación de chunks)
    ...
    switch (loader) {
      ...
      case "neoforge":
        loaderSpecificArgs.push(
          ...
          // Módulos necesarios para Forge/NeoForge
          "--add-opens",
