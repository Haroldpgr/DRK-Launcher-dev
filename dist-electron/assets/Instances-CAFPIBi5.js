const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-Bf_qyFFt.js","assets/downloadService-AHV6vSr_.js","assets/index-C9GZxdg5.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-C9GZxdg5.js";
import { instanceProfileService } from "./instanceProfileService-Dwc0lupN.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CIyHrr9t.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-Bf_qyFFt.js");
