const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-uI3yxYYe.js","assets/downloadService-CKB78u1A.js","assets/index-U_2yIX1v.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-U_2yIX1v.js";
import { instanceProfileService } from "./instanceProfileService-DdPsqObn.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-Dhkyeyoo.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-uI3yxYYe.js");
