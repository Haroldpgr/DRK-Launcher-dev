const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService--A3KgHJM.js","assets/index-DVYB48ru.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-DVYB48ru.js";
import { C as Card } from "./Card-B5b0kAQ-.js";
import { B as Button } from "./Button-b5_8X-Gv.js";
import { A as AnimatePresence, m as motion } from "./proxy-peocDXjy.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService--A3KgHJM.js");
