const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-CQPrv0Cf.js","assets/downloadService-DU5PxbOA.js","assets/index-B-48dvDC.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-B-48dvDC.js";
import { instanceProfileService } from "./instanceProfileService-s5uNCx7n.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CACOiZYs.js";
import { A as AnimatePresence, m as motion } from "./proxy-CaoO3CaC.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-CQPrv0Cf.js");
