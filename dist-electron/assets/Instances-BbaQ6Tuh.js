const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-_ksRduRL.js","assets/downloadService-6dHa5nN7.js","assets/index-CI5nMIBs.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-CI5nMIBs.js";
import { instanceProfileService } from "./instanceProfileService-DPJJ8lb-.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CblLmrLd.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-_ksRduRL.js");
