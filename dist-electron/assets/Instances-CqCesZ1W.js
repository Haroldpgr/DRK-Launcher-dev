const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-EofwlLII.js","assets/downloadService-BIcbUrn_.js","assets/index-BORWVLYp.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-BORWVLYp.js";
import { instanceProfileService } from "./instanceProfileService-DyJJNqj_.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-Cwh59mUj.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-EofwlLII.js");
