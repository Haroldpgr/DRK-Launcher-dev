const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-Bbw_PKRL.js","assets/downloadService-DshotsWM.js","assets/index-DKu6ENU1.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-DKu6ENU1.js";
import { instanceProfileService } from "./instanceProfileService-D8NEqVj8.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-BSfaaYdj.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-Bbw_PKRL.js");
