const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-CRL3LHK6.js","assets/downloadService-BtwL-RuS.js","assets/index-hPHX05Yf.js","assets/index-D2wnz6PA.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-hPHX05Yf.js";
import { instanceProfileService } from "./instanceProfileService-ut53G8fv.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CsiaT5jZ.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-CRL3LHK6.js");
