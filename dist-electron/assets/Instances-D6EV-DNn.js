const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-F1fIYQ_F.js","assets/downloadService-DTtI1voJ.js","assets/index-jaIHCIBh.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-jaIHCIBh.js";
import { instanceProfileService } from "./instanceProfileService-BEceKkLw.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CHa1h_28.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-F1fIYQ_F.js");
