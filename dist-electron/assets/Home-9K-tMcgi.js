const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-B26xYT4u.js","assets/index-Dn4rZJap.js","assets/index-B4L-bEA7.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-Dn4rZJap.js";
import { C as Card } from "./Card-aQKRLxQY.js";
import { B as Button } from "./Button-CxBNS-vC.js";
import { A as AnimatePresence, m as motion } from "./proxy-CcPspUoE.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-B26xYT4u.js");
