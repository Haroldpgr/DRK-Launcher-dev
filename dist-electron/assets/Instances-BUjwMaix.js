const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-BnyJQDi1.js","assets/downloadService-CJIaUyOT.js","assets/index-C3fgt0AJ.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-C3fgt0AJ.js";
import { instanceProfileService } from "./instanceProfileService-6Y9BVYGn.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-gZkBDOqG.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-BnyJQDi1.js");
