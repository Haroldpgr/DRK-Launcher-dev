const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-DK5V2JVs.js","assets/downloadService-cH_cAddn.js","assets/index-Chwwb7_O.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-Chwwb7_O.js";
import { instanceProfileService } from "./instanceProfileService-Bf6zIufd.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-D7tB_pWF.js";
import { A as AnimatePresence, m as motion } from "./proxy-B4GCuvUx.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-DK5V2JVs.js");
