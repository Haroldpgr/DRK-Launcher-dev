const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-DCdPyZ_Q.js","assets/downloadService-CUxdEMs_.js","assets/index-BSu6-gJL.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-BSu6-gJL.js";
import { instanceProfileService } from "./instanceProfileService-rmpnKpYJ.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-2sN1md0y.js";
import { A as AnimatePresence, m as motion } from "./proxy-BtV15uTN.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-DCdPyZ_Q.js");
