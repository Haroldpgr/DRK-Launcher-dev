const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-BLvMR6lZ.js","assets/index-CWWzT4r9.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-CWWzT4r9.js";
import { C as Card } from "./Card-CPYXADRn.js";
import { B as Button } from "./Button-0ogYLF2o.js";
import { A as AnimatePresence, m as motion } from "./proxy-U9Y0us4c.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-BLvMR6lZ.js");
