const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-JHUf9NPW.js","assets/index-B0sg1rxm.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-B0sg1rxm.js";
import { C as Card } from "./Card-DdAZsczV.js";
import { B as Button } from "./Button-CD3VMLHA.js";
import { A as AnimatePresence, m as motion } from "./proxy-Bj3yGmgR.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-JHUf9NPW.js");
