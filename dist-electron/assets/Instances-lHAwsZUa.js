const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-C_96ehfZ.js","assets/downloadService-AvOJhFm6.js","assets/index-BKV3zAQK.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-BKV3zAQK.js";
import { instanceProfileService } from "./instanceProfileService-C23J6Ofy.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CGO-o1V2.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-C_96ehfZ.js");
