const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-DVdbl5JQ.js","assets/downloadService-C4qyK4Cc.js","assets/index-BmRwQbUr.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-BmRwQbUr.js";
import { instanceProfileService } from "./instanceProfileService-Bwn7BaFR.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-CZxuPKPb.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-DVdbl5JQ.js");
