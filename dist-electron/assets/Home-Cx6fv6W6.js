const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-CfIFka5i.js","assets/index-B_KZpQPc.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-B_KZpQPc.js";
import { C as Card } from "./Card-BPuw0FkS.js";
import { B as Button } from "./Button-B-Ssyaja.js";
import { A as AnimatePresence, m as motion } from "./proxy-CAItg4l8.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-CfIFka5i.js");
