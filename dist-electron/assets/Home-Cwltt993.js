const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-Y8XplLzA.js","assets/index-DXjNF277.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-DXjNF277.js";
import { C as Card } from "./Card--Bthjvqd.js";
import { B as Button } from "./Button-B6d300Kl.js";
import { A as AnimatePresence, m as motion } from "./proxy-ByIDpweK.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-Y8XplLzA.js");
