const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-BUJDdYWH.js","assets/downloadService-CLY-4ElO.js","assets/index-Dn4rZJap.js","assets/index-B4L-bEA7.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-Dn4rZJap.js";
import { instanceProfileService } from "./instanceProfileService-B26xYT4u.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-B5epLrRa.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-BUJDdYWH.js");
