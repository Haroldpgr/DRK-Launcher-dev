const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-0XtxyC-G.js","assets/index-CPYKVHr3.js","assets/index-CvJk9QuK.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-CPYKVHr3.js";
import { C as Card } from "./Card-B_f3TNad.js";
import { B as Button } from "./Button-D8aXbEOv.js";
import { A as AnimatePresence } from "./index-Cq1avr8Q.js";
import { m as motion } from "./proxy-DYTHvejV.js";
...
const ProfileDropdown = reactExports.memo(ProfileDropdown$1);
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-0XtxyC-G.js");
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Card, { children: [
        ...
        last ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex items-center justify-between bg-gray-800/60 backdrop-blur-sm p-4 rounded-xl border border-gray-700/50", children: [
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Button, { onClick: play, disabled: isLaunching || !last, children: isLaunching ? "Iniciando..." : "Jugar" }, void 0, false, {
              fileName: "C:/Users/harol/OneDrive/Documentos/Plan_Nuevo/src/renderer/pages/Home.tsx",
              lineNumber: 315,
              columnNumber: 17
            }, this),
