const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-CgMEwaHt.js","assets/downloadService-CS_HPhFB.js","assets/index-2tM5GWCs.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-2tM5GWCs.js";
import { instanceProfileService } from "./instanceProfileService-DbT_9Hes.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-DFYZR8P4.js";
import { A as AnimatePresence, m as motion } from "./proxy-BvRAZMQr.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-CgMEwaHt.js");
