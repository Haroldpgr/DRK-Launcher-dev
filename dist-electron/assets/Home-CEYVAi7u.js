const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-DA85TyTw.js","assets/index-CP7ng7wh.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-CP7ng7wh.js";
import { C as Card } from "./Card-VusvV4lK.js";
import { B as Button } from "./Button-BQb-34kp.js";
import { A as AnimatePresence, m as motion } from "./proxy-W3Ae0ojv.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-DA85TyTw.js");
