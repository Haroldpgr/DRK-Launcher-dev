const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-60iX0aU8.js","assets/downloadService-d6N3hQ7F.js","assets/index-JTQto-q-.js","assets/index-DbpeiShv.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService, n as notificationService } from "./index-JTQto-q-.js";
import { instanceProfileService } from "./instanceProfileService-5uv4upVu.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-DVhXEH-m.js";
import { A as AnimatePresence } from "./index-DMuNbkCC.js";
import { m as motion } from "./proxy-Cndl-i4F.js";
import { C as ConfirmationModal } from "./ConfirmationModal-BWZzQ1k-.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-60iX0aU8.js");
...
function GameLogsModal({ instanceId, instanceName, isOpen, onClose }) {
  ...
  const loadLogs = async () => {
    var _a, _b;
    try {
      if (!((_b = (_a = window.api) == null ? void 0 : _a.game) == null ? void 0 : _b.getLogs)) {
        setError("API de logs no disponible");
        return;
      }
      ...
      children: [
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          "div",
          {
            ...
            children: error ? /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "text-red-400 p-4 bg-red-900/20 rounded-lg border border-red-700/50", children: error }, void 0, false, {
              fileName: "C:/Users/harol/OneDrive/Documentos/Plan_Nuevo/src/renderer/components/GameLogsModal.tsx",
              lineNumber: 186,
              columnNumber: 15
