const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-D37u2Luo.js","assets/index-DxwT0I4E.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-DxwT0I4E.js";
import { C as Card } from "./Card-DXSlgXdm.js";
import { B as Button } from "./Button-C1SWSbDn.js";
import { A as AnimatePresence, m as motion } from "./proxy-DGh5IrtD.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-D37u2Luo.js");
