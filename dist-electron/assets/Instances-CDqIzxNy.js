const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-D6nJcA4A.js","assets/downloadService-CWEBNwau.js","assets/index-B0sg1rxm.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-B0sg1rxm.js";
import { instanceProfileService } from "./instanceProfileService-JHUf9NPW.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-C6XWnx-5.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-D6nJcA4A.js");
