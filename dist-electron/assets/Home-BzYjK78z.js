const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-Bwn7BaFR.js","assets/index-BmRwQbUr.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-BmRwQbUr.js";
import { C as Card } from "./Card-Cpnwd7PH.js";
import { B as Button } from "./Button-BHcT-mFF.js";
import { A as AnimatePresence, m as motion } from "./proxy-ChYCzo-3.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-Bwn7BaFR.js");
