const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-D_aS1pco.js","assets/downloadService-OCOiS7Da.js","assets/index-BU0XOqXY.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-BU0XOqXY.js";
import { instanceProfileService } from "./instanceProfileService-6wYWkvox.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-DO5AtMn1.js";
import { A as AnimatePresence, m as motion } from "./proxy-DdTLO9BF.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-D_aS1pco.js");
