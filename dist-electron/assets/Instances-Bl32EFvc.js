const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-DlFuiWGd.js","assets/downloadService-S0K-xAY2.js","assets/index-f-PrhMeP.js","assets/index-C763eF6j.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-f-PrhMeP.js";
import { instanceProfileService } from "./instanceProfileService-Yg16xu-I.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-B7-_Xya-.js";
import { A as AnimatePresence, m as motion } from "./proxy-Y0g_QanL.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-DlFuiWGd.js");
