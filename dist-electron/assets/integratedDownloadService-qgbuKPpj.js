class IntegratedDownloadService {
  ...
  async getIncompleteDownloads() {
    var _a, _b;
    if (!((_b = (_a = window.api) == null ? void 0 : _a.instance) == null ? void 0 : _b.getIncompleteDownloads)) {
      return [];
    }
  ...
  async resumeDownload(downloadId) {
    var _a, _b;
    if (!((_b = (_a = window.api) == null ? void 0 : _a.instance) == null ? void 0 : _b.resumeDownload)) {
