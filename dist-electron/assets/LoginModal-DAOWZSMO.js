const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BLDqQRLV.js","assets/index-0SWpjQyZ.css"])))=>i.map(i=>d[i]);
import { r as reactExports, j as jsxDevRuntimeExports, _ as __vitePreload } from "./index-BLDqQRLV.js";
  ...
  const handleMicrosoftLoginConfirm = async () => {
    ...
    try {
      ...
      if (result && result.success && result.selectedProfile) {
        const profileService = await __vitePreload(() => import("./index-BLDqQRLV.js").then((n) => n.d), true ? __vite__mapDeps([0,1]) : void 0);
