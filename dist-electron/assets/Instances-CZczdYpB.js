const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-DwsfOFrw.js","assets/downloadService-DS1qskJz.js","assets/index-CPoURSBc.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-CPoURSBc.js";
import { instanceProfileService } from "./instanceProfileService-BM6fijnx.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-C2Ly4aBV.js";
import { A as AnimatePresence, m as motion } from "./proxy-C3QRfHfn.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-DwsfOFrw.js");
