const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-DX9IWZVA.js","assets/index-Doo-7BUy.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-Doo-7BUy.js";
import { C as Card } from "./Card-DUJZO7SE.js";
import { B as Button } from "./Button-DZeiiJWq.js";
import { A as AnimatePresence, m as motion } from "./proxy-B6JBgxda.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-DX9IWZVA.js");
