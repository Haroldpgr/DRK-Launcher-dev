const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/instanceProfileService-C23J6Ofy.js","assets/index-BKV3zAQK.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { j as jsxDevRuntimeExports, r as reactExports, R as React, _ as __vitePreload } from "./index-BKV3zAQK.js";
import { C as Card } from "./Card-DMbhhfdb.js";
import { B as Button } from "./Button-BEFOr8c0.js";
import { A as AnimatePresence, m as motion } from "./proxy-DCp0ILzx.js";
  ...
  const autoDetectAndLoadInstances = async () => {
    ...
    try {
      ...
      if ((_d = (_c = window.api) == null ? void 0 : _c.instances) == null ? void 0 : _d.list) {
        ...
        if (currentUser) {
          __vitePreload(async () => {
            const { instanceProfileService } = await import("./instanceProfileService-C23J6Ofy.js");
