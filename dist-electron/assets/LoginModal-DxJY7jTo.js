const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CPYKVHr3.js","assets/index-CvJk9QuK.css"])))=>i.map(i=>d[i]);
import { r as reactExports, j as jsxDevRuntimeExports, _ as __vitePreload } from "./index-CPYKVHr3.js";
  ...
  const handleMicrosoftLoginConfirm = async () => {
    ...
    try {
      ...
      if (result && result.success && result.selectedProfile) {
        const profileService = await __vitePreload(() => import("./index-CPYKVHr3.js").then((n) => n.d), true ? __vite__mapDeps([0,1]) : void 0);
