const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/javaDownloadService-D2gERo9j.js","assets/downloadService-C1tgG5i8.js","assets/index-BmOgVBUa.js","assets/index-C7_Wleq-.css"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, j as jsxDevRuntimeExports, p as profileService } from "./index-BmOgVBUa.js";
import { instanceProfileService } from "./instanceProfileService-dnEJpkIE.js";
import { C as CreateInstanceModal } from "./CreateInstanceModal-Bd8ypGVa.js";
    ...
    try {
      if ((_b = (_a = window.api) == null ? void 0 : _a.java) == null ? void 0 : _b.getAll) {
        ...
        const { javaDownloadService } = await __vitePreload(async () => {
          const { javaDownloadService: javaDownloadService2 } = await import("./javaDownloadService-D2gERo9j.js");
